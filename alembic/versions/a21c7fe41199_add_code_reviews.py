...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_code_reviews_tenant_id'), 'code_reviews', ['tenant_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_code_reviews_tenant_id'), table_name='code_reviews')
