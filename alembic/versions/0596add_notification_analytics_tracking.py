...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_notification_analytics_notification_id"), "notification_analytics", ["notification_id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_notification_analytics_notification_id"), table_name="notification_analytics")
