"""add_dashboard_report_chartdata

Revision ID: 3d9f46ff44b8
Revises: 8b65fe079d37
Create Date: 2026-05-20 23:50:55.808794
...
revision: str = '3d9f46ff44b8'
down_revision: Union[str, None] = '8b65fe079d37'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_chart_data_report_id'), 'chart_data', ['report_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_chart_data_report_id'), table_name='chart_data')
